...
import { AnimEntityLoader } from "./src/AnimEntityLoader";
...
new AnimEntityLoader().load('LegoRR0/mini-figures/pilot/pilot.ae', function (animFile) {
    ...
    entity1.setPoly(entity1.highPoly);
    ...
    entity2.setPoly(entity2.highPoly);
    ...
    entity3.setPoly(entity3.highPoly);
...
new AnimEntityLoader().load('LegoRR0/creatures/rmonster/rmonster.ae', function (animFile) {
    ...
    entity.setPoly(entity.highPoly);
